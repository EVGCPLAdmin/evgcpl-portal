...
const PORTAL_VERSION  = '3.13.3';
const PORTAL_BUILD    = 352;
const PORTAL_BUILD_AT = '2026-05-12T14:24:26Z';
...
const EXEC_REGISTRY_DEFAULTS = {
  main:        { label: 'Main Backend (default)', desc: 'Most portal POSTs (DPR, Safety, PCC, Onboarding, Reports). Default for getExec().', defaultUrl: 'https://script.google.com/macros/s/AKfycbwtCxCExP9VZU25B4FfzzU69yEDGuNDY8mBsifa-ecSEEN30ihPmApwW--dR9n1WmA/exec' },
  pinReset:    { label: 'PIN Reset',              desc: 'v2_PINReset bound to UserSecrets sheet.',                                          defaultUrl: 'https://script.google.com/macros/s/AKfycbwtCxCExP9VZU25B4FfzzU69yEDGuNDY8mBsifa-ecSEEN30ihPmApwW--dR9n1WmA/exec' },
  aiProxy:     { label: 'AI Proxy (Groq)',        desc: 'aiProxy action — Groq llama-3.3-70b-versatile via Apps Script.',                   defaultUrl: 'https://script.google.com/macros/s/AKfycbwtCxCExP9VZU25B4FfzzU69yEDGuNDY8mBsifa-ecSEEN30ihPmApwW--dR9n1WmA/exec' },
  diagnostic:  { label: 'Sheet Diagnostic',       desc: 'Sharing-Doctor — server-side sheet sharing checks (status/redirect/sniff).',       defaultUrl: 'https://script.google.com/macros/s/AKfycbwtCxCExP9VZU25B4FfzzU69yEDGuNDY8mBsifa-ecSEEN30ihPmApwW--dR9n1WmA/exec' },
